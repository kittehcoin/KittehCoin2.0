...
The KittehCoin2.0 Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the KittehCoin2.0 Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/kittehcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to kittehcoin-qt
...
The following applies to code changes to the KittehCoin2.0 Core project (and related
projects such as libsecp256k1), and is not to be confused with overall KittehCoin
Network Protocol consensus changes.

Whether a pull request is merged into KittehCoin2.0 Core rests with the project merge
...
Patches that change KittehCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the KittehCoin consensus, it must have been
...
The project leader is the release manager for each KittehCoin2.0 Core release.
