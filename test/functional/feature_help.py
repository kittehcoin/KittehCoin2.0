...
"""Verify that starting kittehcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kittehcoin with -h for help text")
        ...
        self.log.info("Start kittehcoin with -version for version information")
        ...
        self.log.info("Start kittehcoind with -fakearg to make sure it does not start")
