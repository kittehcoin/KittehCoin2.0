...
public:
    ...
    //! Cumulative minted subsidy (not fees) in the chain up to and including this block.
    //! Used to enforce MAX_MONEY. Persisted in CDiskBlockIndex.
...
public:
    ...
    SERIALIZE_METHODS(CDiskBlockIndex, obj)
    {
        ...
        // KittehCoin 2.0: circulating subsidy total for MAX_MONEY enforcement
        READWRITE(VARINT_MODE(obj.nMoneySupply, VarIntMode::NONNEGATIVE_SIGNED));
    }
