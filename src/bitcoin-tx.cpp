...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kittehcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kittehcoin-tx [options] <hex-tx> [commands]  Update hex-encoded kittehcoin transaction\n" +
            "or:     kittehcoin-tx [options] -create [commands]   Create hex-encoded kittehcoin transaction\n" +
            "\n";
