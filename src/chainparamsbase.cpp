...
{
    // KittehCoin 2.0 ports (RPC / onion) — P2P defaults live in chainparams.cpp
    // Original KittehCoin: RPC 22565, P2P 22566; testnet RPC 44565, P2P 44566
    if (chain == CBaseChainParams::MAIN) {
        return MakeUnique<CBaseChainParams>("", 22565, 22566);
    } else if (chain == CBaseChainParams::TESTNET) {
        return MakeUnique<CBaseChainParams>("testnet4", 44565, 44566);
    } else if (chain == CBaseChainParams::SIGNET) {
        return MakeUnique<CBaseChainParams>("signet", 44567, 44568);
    } else if (chain == CBaseChainParams::REGTEST) {
        return MakeUnique<CBaseChainParams>("regtest", 18445, 18446);
    }
