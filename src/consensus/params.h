...
struct Params {
    ...
    /** KittehCoin 2.0: use Kimoto Gravity Well (original KittehCoin difficulty) */
    bool fPowKimotoGravityWell{false};
    uint64_t nKGWPastBlocksMin{36};
    uint64_t nKGWPastBlocksMax{1008};
