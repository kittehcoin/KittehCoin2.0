...
- 24GB of free disk space on the partition that the KittehCoin2.0 git repository
  resides in
...
For a KittehCoin2.0 Core depends development environment, simply invoke
...
From the top of a clean KittehCoin2.0 Core repository:
...
To use dongcarl's substitute server for KittehCoin2.0 Core builds after having
